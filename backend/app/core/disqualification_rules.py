...
def get_disqualification_rules() -> List[DisqualificationRule]:
    ...
    return [
        ...
        DisqualificationRule("12.1.E", "Documentación alterada, tachada o enmendada.", r"(?i)tachad[ao]|enmend[ao]|raspadur[ao]|alterad[ao]\s+(?:por|con|en)\s+(?:el\s+)?licitante", None, "compliance.data"),
        ...
        DisqualificationRule("12.1.J", "Falta de firma o identificación.", r"(?i)(documento|propuesta|escrito|formato|anexo)\s+(sin\s+firma|no\s+firmad[ao]|falta\s+de\s+firma|sin\s+identificaci[oó]n)", None, "compliance.data"),
